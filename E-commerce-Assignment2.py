...
customer_user = "buyer1"
customer_pass = "buy123"
...
elif username == cashier_user and password == cashier_pass:
    access_level = "Cashier"
    print("\nLogin Successful! Welcome, Cashier.")
elif username == customer_user and password == customer_pass:
...
if access_level != "":
    ...
    location = input("Enter your location state (e.g., NORTHERN, CENTRAL, EASTERN): ").upper()
